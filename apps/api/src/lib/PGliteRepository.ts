...
const hasRows = (rows: unknown[]): rows is [DbRow, ...DbRow[]] => rows.length > 0;
...
export class PGliteRepository implements Repository {
  ...
  async createSource(input: CreateSourceRequest): Promise<StoredSource> {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to create source in PGlite.");
    }
  ...
  async getSource(id: string): Promise<StoredSource | null> {
    ...
    return hasRows(query.rows) ? mapSourceRow(query.rows[0]) : null;
  }
  ...
  async createEvent(
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to create event in PGlite.");
    }
  ...
  async getEvent(id: string): Promise<StoredEvent | null> {
    ...
    return hasRows(query.rows) ? mapEventRow(query.rows[0]) : null;
  }
  ...
  async createPrediction(
    ...
    return db.transaction(async (tx: Transaction) => {
      const predictionQuery = await tx.query(
      ...
      const assetsQuery = await tx.query(
      ...
      if (!hasRows(predictionQuery.rows)) {
        throw new Error("Failed to create prediction in PGlite.");
      }

      return mapPredictionRow(predictionQuery.rows[0], assetsQuery.rows as DbRow[]);
    });
  }
  ...
  async updatePredictionStatus(id: string, status: StoredPrediction["status"]) {
    ...
    return mapPredictionRow(query.rows[0], assetsQuery.rows as DbRow[]);
  }
  ...
  async listPendingPredictionsReadyForScoring(asOf: string): Promise<PendingPredictionRecord[]> {
    ...
    for (const row of query.rows as DbRow[]) {
  ...
  async getOutcomeByPredictionId(predictionId: string): Promise<PredictionOutcome | null> {
    ...
    return hasRows(query.rows) ? mapOutcomeRow(query.rows[0]) : null;
  }
  ...
  async getPostmortemByPredictionId(predictionId: string): Promise<Postmortem | null> {
    ...
    return hasRows(query.rows) ? mapPostmortemRow(query.rows[0]) : null;
  }
  ...
  async getHistoricalCaseLibraryItem(caseId: string) {
    ...
    return hasRows(query.rows) ? mapHistoricalCaseLibraryRow(query.rows[0]) : null;
  }
  ...
  async countHistoricalCaseLibraryItems(options: {
    ...
    return Number((query.rows[0] as DbRow | undefined)?.total ?? 0);
  }
  ...
  async listHistoricalCaseLibraryItems(options: {
    ...
    return (query.rows as DbRow[]).map(mapHistoricalCaseLibraryRow);
  }
  ...
  async saveHistoricalCaseLibraryItem(item: HistoricalCaseLibraryItem) {
    ...
    return mapHistoricalCaseLibraryRow(query.rows[0] as DbRow);
  }
  ...
  async listLessons(): Promise<Lesson[]> {
    ...
    return (query.rows as DbRow[]).map(mapLessonRow);
  }
  ...
  async saveModelVersion(input: CreateModelVersionRequest) {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to save model version in PGlite.");
    }
  ...
  async getModelVersion(modelVersion: string): Promise<StoredModelVersion | null> {
    ...
    return hasRows(query.rows) ? mapModelVersionRow(query.rows[0]) : null;
  }
  ...
  async listModelVersions(): Promise<StoredModelVersion[]> {
    ...
    return (query.rows as DbRow[]).map(mapModelVersionRow);
  }
  ...
  async createTranscriptSession(input: CreateTranscriptSessionRequest) {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to create transcript session in PGlite.");
    }
  ...
  async getTranscriptSession(id: string): Promise<StoredTranscriptSession | null> {
    ...
    return hasRows(query.rows) ? mapTranscriptSessionRow(query.rows[0]) : null;
  }
  ...
  async getTranscriptStreamBinding(
    ...
    return hasRows(query.rows) ? mapTranscriptStreamBindingRow(query.rows[0]) : null;
  }
  ...
  async upsertTranscriptStreamBinding(input: {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to upsert transcript stream binding in PGlite.");
    }
  ...
  async listTranscriptStreamBindings(limit = 20): Promise<TranscriptStreamBinding[]> {
    ...
    return (query.rows as DbRow[]).map(mapTranscriptStreamBindingRow);
  }
  ...
  async getTranscriptStreamBuffer(
    ...
    return hasRows(query.rows) ? mapTranscriptStreamBufferRow(query.rows[0]) : null;
  }
  ...
  async upsertTranscriptStreamBuffer(input: {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to upsert transcript stream buffer in PGlite.");
    }
  ...
  async appendTranscriptSessionChunk(
    ...
    return db.transaction(async (tx: Transaction) => {
      const sequenceQuery = await tx.query(
        `select coalesce(max(sequence), 0) + 1 as next_sequence
         from transcript_chunks
         where session_id = $1`,
        [sessionId],
      );
      const sequence = Number((sequenceQuery.rows as DbRow[])[0]?.next_sequence ?? 1);
      const insertQuery = await tx.query(
      ...
      if (!hasRows(insertQuery.rows)) {
        throw new Error("Failed to append transcript chunk in PGlite.");
      }
  ...
  async listTranscriptSessionChunks(sessionId: string): Promise<StoredTranscriptChunk[]> {
    ...
    return (query.rows as DbRow[]).map(mapTranscriptChunkRow);
  }
  ...
  async getLatestTranscriptSessionAnalysis(
    ...
    return hasRows(query.rows) ? mapTranscriptSessionAnalysisRow(query.rows[0]) : null;
  }
  ...
  async listCalibrationSnapshots(limit = 20): Promise<CalibrationSnapshot[]> {
    ...
    return (query.rows as DbRow[]).map(mapCalibrationSnapshotRow);
  }
  ...
  async listBenchmarkReplaySnapshots(
    ...
    return (query.rows as DbRow[]).map(mapBenchmarkReplaySnapshotRow);
  }
  ...
  async listWalkForwardReplaySnapshots(
    ...
    return (query.rows as DbRow[]).map(mapWalkForwardReplaySnapshotRow);
  }
  ...
  async listBenchmarkTrustRefreshes(
    ...
    return (query.rows as DbRow[]).map(mapBenchmarkTrustRefreshRow);
  }
  ...
  async saveOperationRun(run: Omit<OperationRunRecord, "id" | "created_at">) {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to save operation run in PGlite.");
    }
  ...
  async listOperationRuns(options: {
    ...
    return (query.rows as DbRow[]).map(mapOperationRunRow);
  }
  ...
  async acquireOperationLease(input: {
    ...
    return hasRows(query.rows) ? mapOperationLeaseRow(query.rows[0]) : null;
  }
  ...
  async listOperationLeases(options: {
    ...
    return (query.rows as DbRow[]).map(mapOperationLeaseRow);
  }
  ...
  async enqueueOperationJob(input: {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to enqueue operation job in PGlite.");
    }
  ...
  async getOperationJob(id: string) {
    ...
    return hasRows(query.rows) ? mapOperationJobRow(query.rows[0]) : null;
  }
  ...
  async listOperationJobs(options: {
    ...
    return (query.rows as DbRow[]).map(mapOperationJobRow);
  }
  ...
  async upsertOperationWorker(input: {
    ...
    return mapOperationWorkerRow((query.rows[0] ?? {}) as DbRow);
  }
  ...
  async listOperationWorkers(options: { limit?: number } = {}) {
    ...
    return (query.rows as DbRow[]).map(mapOperationWorkerRow);
  }
  ...
  async upsertOperationWorkerService(input: {
    ...
    const query = await db.query(
      `insert into operation_worker_services (
         ...
         heartbeat_interval_ms, max_restarts, restart_count, restart_streak,
         current_restart_backoff_ms, started_at,
    ...
    return mapOperationWorkerServiceRow((query.rows[0] ?? {}) as DbRow);
  }
  ...
  async listOperationWorkerServices(options: { limit?: number } = {}) {
    ...
    return (query.rows as DbRow[]).map(mapOperationWorkerServiceRow);
  }
  ...
  async getOperationWorkerService(serviceId: string) {
    ...
    return query.rows[0] ? mapOperationWorkerServiceRow(query.rows[0] as DbRow) : null;
  }
  ...
  async saveOperationWorkerServiceEvent(
    ...
    return mapOperationWorkerServiceEventRow((query.rows as DbRow[])[0] ?? {});
  }
  ...
  async listOperationWorkerServiceEvents(
    ...
    return (query.rows as DbRow[]).map(mapOperationWorkerServiceEventRow);
  }
  ...
  async saveOperationWorkerEvent(
    ...
    return mapOperationWorkerEventRow((query.rows[0] ?? {}) as DbRow);
  }
  ...
  async listOperationWorkerEvents(
    ...
    return (query.rows as DbRow[]).map(mapOperationWorkerEventRow);
  }
  ...
  async saveSystemIntegrationGovernanceState(state: SystemIntegrationGovernanceState) {
    ...
    return mapSystemIntegrationGovernanceStateRow((query.rows[0] ?? {}) as DbRow);
  }
  ...
  async listSystemIntegrationGovernanceStates(options?: {
    ...
    return (query.rows as DbRow[]).map(mapSystemIntegrationGovernanceStateRow);
  }
  ...
  async saveSystemIntegrationProbeState(state: SystemIntegrationProbeState) {
    ...
    return mapSystemIntegrationProbeStateRow((query.rows[0] ?? {}) as DbRow);
  }
  ...
  async listSystemIntegrationProbeStates(options?: {
    ...
    return (query.rows as DbRow[]).map(mapSystemIntegrationProbeStateRow);
  }
  ...
  async getEvolutionScheduleConfig(id = "default"): Promise<EvolutionScheduleConfig | null> {
    ...
    return hasRows(query.rows) ? mapEvolutionScheduleConfigRow(query.rows[0]) : null;
  }
  ...
  async saveEvolutionScheduleConfig(config: EvolutionScheduleConfig) {
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to save evolution schedule config in PGlite.");
    }
  ...
  async getGrowthPressurePolicy(family: string) {
    ...
    return hasRows(query.rows) ? mapGrowthPressurePolicyRow(query.rows[0]) : null;
  }
  ...
  async listGrowthPressurePolicies(): Promise<GrowthPressurePolicy[]> {
    ...
    return (query.rows as DbRow[]).map(mapGrowthPressurePolicyRow);
  }
  ...
  async saveGrowthPressurePolicy(policy: GrowthPressurePolicy) {
    ...
    return mapGrowthPressurePolicyRow(query.rows[0] as DbRow);
  }
  ...
  async getGrowthPressureAlert(id: string) {
    ...
    return hasRows(query.rows) ? mapGrowthPressureAlertRow(query.rows[0]) : null;
  }
  ...
  async listGrowthPressureAlerts(options: {
    ...
    return (query.rows as DbRow[]).map(mapGrowthPressureAlertRow);
  }
  ...
  async saveGrowthPressureAlert(alert: StoredGrowthPressureAlert) {
    ...
    return mapGrowthPressureAlertRow(query.rows[0] as DbRow);
  }
  ...
  async getGrowthPressureActionPlan(id: string) {
    ...
    return hasRows(query.rows) ? mapGrowthPressureActionPlanRow(query.rows[0]) : null;
  }
  ...
  async listGrowthPressureActionPlans(options: {
    ...
    return (query.rows as DbRow[]).map(mapGrowthPressureActionPlanRow);
  }
  ...
  async saveGrowthPressureActionPlan(plan: GrowthPressureActionPlan) {
    ...
    return mapGrowthPressureActionPlanRow(query.rows[0] as DbRow);
  }
  ...
  async listLineageSnapshots(limit = 20): Promise<LineageSnapshot[]> {
    ...
    return (query.rows as DbRow[]).map(mapLineageSnapshotRow);
  }
  ...
  async savePromotionEvaluation(
    ...
    if (!hasRows(query.rows)) {
      throw new Error("Failed to save promotion evaluation in PGlite.");
    }
  ...
  async listPromotionEvaluations(
    ...
    return (query.rows as DbRow[]).map(mapPromotionEvaluationRow);
  }
...
export const createPGliteRepository = (dataDir: string) => new PGliteRepository(dataDir);
